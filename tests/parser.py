        ...
        if data_id in encoding_rules:
            if data_type == 0:
                ...
                if encoding_rules[data_id] == "double":
                    ...
                    decode_data[prop_names[data_id]] = int.from_bytes(byte_str[i:i + 8], byteorder="little", signed=True)
                ...
                if encoding_rules[data_id] == "float":
                    ...
                    decode_data[prop_names[data_id]] = int.from_bytes(byte_str[i:i + 4], byteorder="little", signed=True)
